...
KEYS=(
    ...
    "/prod/kodus-service-ast/LANGCHAIN_TRACING_V2"
    "/prod/kodus-service-ast/LANGCHAIN_ENDPOINT"
    "/prod/kodus-service-ast/LANGCHAIN_HUB_API_URL"
    "/prod/kodus-service-ast/LANGCHAIN_API_KEY"
    "/prod/kodus-service-ast/LANGCHAIN_PROJECT"
    "/prod/kodus-service-ast/LANGCHAIN_CALLBACKS_BACKGROUND"
